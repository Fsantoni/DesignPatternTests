...
in risposta all'essenza abbiamo individuato le criticità...

\subsection{Testing}
Per eliminiare la possibilità di criticità x e y abbiamo ritenuto necessario e/o sufficiente testare A e B: 
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=1\textwidth]{./LaTeX_extra/logo-unifi-1.png}
...
\subsubsection{Tests}
abbiamo fatto test sia di unità che di interazione:
